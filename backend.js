...
//
//  1) CSAK a loopback interfészen figyel. Korábban az Express alapértelmezése
...
//  2) A kliens által küldött `id`-t eldobjuk (a frontendben ez tárolt XSS volt).
//  3) Bemenet-fehérlista és hosszkorlátok.
//  4) ATOMI írás + soros végrehajtás. Korábban két egyszerre érkező kérés
...
//  5) A normPath a frontenddel MEGEGYEZŐEN a `\` ismétlődéseket is összevonja
...
// Állapotjelző — adatot NEM ad vissza.
app.get("/", (req, resp) => resp.type("text/plain").send("Prohuman Scanner Backend v2.0.0"));
